...
import de.skillmatrix.app.domain.Skill;
import de.skillmatrix.app.repository.SkillRepository;
...
/**
 * REST controller for managing {@link de.skillmatrix.app.domain.Skill}.
 */
@RestController
@RequestMapping("/api")
@Transactional
