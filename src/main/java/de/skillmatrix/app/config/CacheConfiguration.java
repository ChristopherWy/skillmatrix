package de.skillmatrix.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.skillmatrix.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.skillmatrix.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
